...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      <img src="{{asset('img/Logo-GSW-chapado.png')}}"  alt="GSW - Soluções Integradas">
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/solicitar-visita"><i class="fa fa-link"></i> <span>Solicitar Visita</span></a></li>
        <li class="treeview">
